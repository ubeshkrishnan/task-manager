...
class BasicNavs extends React.Component {
    ...
    return (
        <div className="border-top mt-5 pt-3">
            <ul className="nav nav-tabs tab-card px-3 border-bottom-0" role="tablist">
                <li className="nav-item"><a className="nav-link bnodal-nav-link-1 active" data-bs-toggle="tab" href="#!" onClick={(e)=>{e.preventDefault(); this.tabEvent(e,"bnodal-nav-Preview1","bnodal-tab-pane-1","bnodal-nav-link-1") }}>Preview</a></li>
                <li className="nav-item"><a className="nav-link bnodal-nav-link-1" data-bs-toggle="tab" href="#!" onClick={(e)=>{e.preventDefault(); this.tabEvent(e,"bnodal-nav-HTML1","bnodal-tab-pane-1","bnodal-nav-link-1") }}>HTML</a></li>
            </ul>
...
<ul class="nav justify-content-end">
    ...
    <li class="nav-item"><a class="nav-link disabled" href="#"  aria-disabled="true">Disabled</a></li>
            ...
            <ul className="nav nav-tabs tab-card px-3 border-bottom-0" role="tablist">
                <li className="nav-item"><a className="nav-link bnodal-nav-link-2 active" href="#nav-Preview2" onClick={(e)=>{e.preventDefault(); this.tabEvent(e,"bnodal-nav-Preview2","bnodal-tab-pane-2","bnodal-nav-link-2") }}>Preview</a></li>
                <li className="nav-item"><a className="nav-link bnodal-nav-link-2" href="#nav-HTML2" onClick={(e)=>{e.preventDefault(); this.tabEvent(e,"bnodal-nav-HTML2","bnodal-tab-pane-2","bnodal-nav-link-2") }} >HTML</a></li>
            </ul>
            <div className="card mb-3">
                <div className="card-body">
                    <div className="tab-content">
    ...
    <a class="nav-link disabled" href="#"  aria-disabled="true">Disabled</a>
            ...
            <ul className="nav nav-tabs tab-card px-3 border-bottom-0" role="tablist">
                <li className="nav-item"><a className="nav-link bnodal-nav-link-3 active" href="#nav-Preview3" onClick={(e)=>{e.preventDefault(); this.tabEvent(e,"bnodal-nav-Preview3","bnodal-tab-pane-3","bnodal-nav-link-3") }}>Preview</a></li>
                <li className="nav-item"><a className="nav-link bnodal-nav-link-3" href="#nav-HTML3" onClick={(e)=>{e.preventDefault(); this.tabEvent(e,"bnodal-nav-HTML3","bnodal-tab-pane-3","bnodal-nav-link-3") }}>HTML</a></li>
            </ul>
            <div className="card mb-3">
                <div className="card-body">
                    <div className="tab-content">
