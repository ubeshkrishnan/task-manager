...
class ButtonsGroupTile extends React.Component {
    state={
        isCheckbox1:true,
        isCheckbox2:false,
        isCheckbox3:false,
  ...
  render(){
      const { isCheckbox1,isCheckbox2,isCheckbox3,isCheckRadio1,isCheckRadio2,isCheckRadio3} = this.state;
    return (
    ...
    <button type="button" className="btn btn-outline-primary">Right</button>
                                    ...
                                    <div className="bd-example mb-5">
                                        <div className="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                                            ...
                                            <label className="btn btn-outline-primary" onClick={()=>{ this.setState({ isCheckbox1:!isCheckbox1 }); }} >Checkbox 1</label>
                                        
                                            <input type="checkbox" className="btn-check" id="btncheck2" checked={isCheckbox2} onChange={()=>{ this.setState({ isCheckbox2:!isCheckbox2 }) }}/>
                                            <label className="btn btn-outline-primary" onClick={()=>{ this.setState({ isCheckbox2:!isCheckbox2 }) }}>Checkbox 2</label>
                                        
                                            <input type="checkbox" className="btn-check" id="btncheck3" checked={isCheckbox3} onChange={()=>{ this.setState({ isCheckbox3:!isCheckbox3 }) }}/>
                                            <label className="btn btn-outline-primary" onClick={()=>{ this.setState({ isCheckbox3:!isCheckbox3 }) }}>Checkbox 3</label>
                                        </div>
                                        <SyntaxHighlighter language="javascript" className="mt-2 language-html py-2 px-2"  style={a11yLight}>
                                {`<div className="btn-group" role="group" aria-label="Basic checkbox toggle button group">
    <input type="checkbox" className="btn-check" id="btncheck1" checked={isCheckbox1} onChange={()=>{ this.setState({ isCheckbox1:!isCheckbox1 }); }} />
    ...
    <label className="btn btn-outline-primary">Checkbox 3</label>
                                    ...
                                    <div className="bd-example mb-5">
                                        <div className="btn-group" role="group" aria-label="Basic radio toggle button group">
                                            ...
                                            <label className="btn btn-outline-primary" onClick={()=>{ this.setState({ isCheckRadio1:!isCheckRadio1 }) }}>Radio 1</label>
                                            ...
                                            <label className="btn btn-outline-primary" onClick={()=>{ this.setState({ isCheckRadio2:!isCheckRadio2 }) }}>Radio 2</label>
                                            ...
                                            <label className="btn btn-outline-primary" onClick={()=>{ this.setState({ isCheckRadio3:!isCheckRadio3 }) }}>Radio 3</label>
                                        </div>
                                        <SyntaxHighlighter language="javascript" className="mt-2 language-html py-2 px-2"  style={a11yLight}>
                                {`<div className="btn-group" role="group" aria-label="Basic radio toggle button group">
    <input type="radio" className="btn-check" name="btnradio" id="btnradio1" checked={isCheckRadio1} onChange={()=>{ this.setState({ isCheckRadio1:!isCheckRadio1 }) }} />
            ...
            <li><a className="dropdown-item" href="#!">Dropdown link</a></li>
                                    ...
                                    <div className="bd-example">
                                        <div className="btn-group-vertical" role="group" aria-label="Vertical radio toggle button group">
                                            ...
                                            <label className="btn btn-outline-danger" onClick={()=>{ this.setState({ isCheckRadio1:!isCheckRadio1 }) }}>Radio 1</label>
                                            ...
                                            <label className="btn btn-outline-danger" onClick={()=>{ this.setState({ isCheckRadio2:!isCheckRadio2 }) }}>Radio 2</label>
                                            ...
                                            <label className="btn btn-outline-danger" onChange={()=>{ this.setState({ isCheckRadio3:!isCheckRadio3 }) }}>Radio 3</label>
                                        </div>
                                        <SyntaxHighlighter language="javascript" className="mt-2 language-html py-2 px-2"  style={a11yLight}>
                                {`<div className="btn-group-vertical" role="group" aria-label="Vertical radio toggle button group">
    <input type="radio" className="btn-check" name="vbtn-radio" id="vbtn-radio1" checked={isCheckRadio1} onChange={()=>{ this.setState({ isCheckRadio1:!isCheckRadio1 }) }}/>
