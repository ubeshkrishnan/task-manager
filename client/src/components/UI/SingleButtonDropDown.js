...
class SingleButtonDropDown extends React.Component {
    ...
    return (
        <div className="border-top mt-5 pt-3">
            ...
            <ul className="nav nav-tabs tab-card px-3 border-bottom-0" role="tablist">
                <li className="nav-item"><a className="nav-link nav-link-1 active" id="tab1" href="#!" onClick={(e)=>{e.preventDefault(); this.tabEvent(e,"nav-Preview1","tab-pane-1","nav-link-1") }}>Preview</a></li>
                <li className="nav-item"><a className="nav-link nav-link-1" id="tab2" href="#!" onClick={(e)=>{e.preventDefault(); this.tabEvent(e,"nav-HTML1","tab-pane-1","nav-link-1") }}>HTML</a></li>
            </ul>
...
<Dropdown className="d-inline-flex m-1">
    ...
    <Dropdown.Menu as="ul" className="dropdown-menu-dark shadow p-3">
        ...
        <li><a className="dropdown-item py-2 rounded" href="#!" onClick={(e)=>{e.preventDefault();}}>Separated link</a></li>
            ...
            <ul className="nav nav-tabs tab-card px-3 border-bottom-0" role="tablist">
                <li className="nav-item"><a className="nav-link nav-link-2 active" href="#!" onClick={(e)=>{e.preventDefault(); this.tabEvent(e,"nav-Preview2","tab-pane-2","nav-link-2") }}>Preview</a></li>
                <li className="nav-item"><a className="nav-link nav-link-2" href="#!" onClick={(e)=>{e.preventDefault(); this.tabEvent(e,"nav-HTML2","tab-pane-2","nav-link-2") }}>HTML</a></li>
            </ul>
            <div className="card mb-3">
...
<Dropdown className="d-inline-flex m-1">
    ...
    <Dropdown.Menu as="ul" className="dropdown-menu-dark shadow p-3">
        ...
        <li><a className="dropdown-item py-2 rounded" href="#!" onClick={(e)=>{e.preventDefault();}}>Separated link</a></li>
            ...
            <ul className="nav nav-tabs tab-card px-3 border-bottom-0" role="tablist">
                <li className="nav-item"><a className="nav-link nav-link-3 active" href="#!" onClick={(e)=>{e.preventDefault(); this.tabEvent(e,"nav-Preview3","tab-pane-3","nav-link-3") }}>Preview</a></li>
                <li className="nav-item"><a className="nav-link nav-link-3" href="#!" onClick={(e)=>{e.preventDefault(); this.tabEvent(e,"nav-HTML3","tab-pane-3","nav-link-3") }}>HTML</a></li>
            </ul>
            <div className="card mb-3">
                <div className="card-body tab-content">
