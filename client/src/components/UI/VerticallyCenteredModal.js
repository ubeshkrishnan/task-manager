    ...
    return (
        <div className="border-top mt-5 pt-3">
            ...
            <ul className="nav nav-tabs tab-card px-3 border-bottom-0" role="tablist">
                <li className="nav-item"><a className="nav-link vcmodal-nav-link-1 active" href="#!"  onClick={(e)=>{e.preventDefault(); this.tabEvent(e,"vcmodal-nav-Preview1","vcmodal-tab-pane-1","vcmodal-nav-link-1") }} >Preview</a></li>
                <li className="nav-item"><a className="nav-link vcmodal-nav-link-1" href="#!"  onClick={(e)=>{e.preventDefault(); this.tabEvent(e,"vcmodal-nav-HTML1","vcmodal-tab-pane-1","vcmodal-nav-link-1") }} >HTML</a></li>
            </ul>
                ...
                <div className="card-body">
                    <div className="tab-content">
                        <div className="tab-pane fade vcmodal-tab-pane-1 active show" id="vcmodal-nav-Preview1" role="tabpanel">
                            <button type="button" className="btn btn-secondary" onClick={()=>{ this.setState({ isModal:true }) }}>Vertically centered modal</button>
                            <button type="button" className="btn btn-secondary ms-1" onClick={()=>{ this.setState({ isModal1:true }) }}>Vertically centered scrollable modal</button>
