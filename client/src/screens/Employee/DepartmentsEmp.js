...
class Departments extends React.Component{
        ...
        columnsT=[
            ...
            },
            {
                ...
                cell:(row)=><div className="btn-group" role="group" aria-label="Basic outlined example">
                            <button className="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#depedit" onClick={()=>{ this.setState({isEditModalData:row,isModal:true,modalheader:'Edit Departments'}) }}><i className="icofont-edit text-success"></i></button>
    ...
    render(){
        const {isModal,isEditModalData,modalheader} = this.state;
        return(
            <div className="container-xxl">
                <PageHeader headerTitle="Departments"   renderRight={()=>{
                    return <div className="col-auto d-flex w-sm-100">
                                <button className="btn btn-dark btn-set-task w-sm-100" onClick={()=>{ this.setState({isModal:true,modalheader:'Add Departments'}) }}><i className="icofont-plus-circle me-2 fs-6"></i>Add Departments</button>
                            </div>
                }}/>
